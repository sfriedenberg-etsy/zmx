//! Embedded shell completion scripts (bash/zsh/fish).
...
const BASH_COMPLETIONS: &str = r#"_zmx_completions() {
...
const ZSH_COMPLETIONS: &str = r#"_zmx() {
...
const FISH_COMPLETIONS: &str = r#"function __zmx_subcommand
